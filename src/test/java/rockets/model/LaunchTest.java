...
public class LaunchTest {
    ...
    public void shouldReturnTrueWhenLaunchesHaveSameDateVehicleServiceANDOrbit() {
        ...
        Rocket vehicle = new Rocket("300th Long March", "China", "China National Space Administration");
        LaunchServiceProvider serviceProvider = new LaunchServiceProvider("China National Space Administration", 1993, "China");
    ...
    public void shouldReturnFalseWhenLaunchesHaveDifferentDateVehicleServiceOROrbit()
    {
        ...
        Rocket vehicle1 = new Rocket("300th Long March", "China", "China National Space Administration");
        Rocket vehicle2 = new Rocket("cat1000", "American", "American National Space Administration");
        Rocket[] vehicles = {vehicle1,vehicle2};
        LaunchServiceProvider serviceProvider1 = new LaunchServiceProvider("China National Space Administration", 1993, "China");
        LaunchServiceProvider serviceProvider2 = new LaunchServiceProvider("American National Space Administration", 1985, "American");
